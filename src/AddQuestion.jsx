...
const AddQuestion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      !difficulty ||
      !description ||
      !images.cppBruteForce ||
      !images.cppOptimized ||
      !images.cppBetter ||
      !images.javaBruteForce ||
      !images.javaOptimized ||
      !images.javaBetter ||
      !images.pythonBruteForce ||
      !images.pythonOptimized ||
      !images.pythonBetter
    ) {
        ...
        <Col md={10}>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group
              as={Row}
              className="mb-3"
              controlId="formJavaBruteForce"
            >
              <Form.Label column sm="2">
                Java Brute Force Image:
              </Form.Label>
              <Col sm="10">
                <Form.Control
                  type="file"
            ...
            <Form.Group
              as={Row}
              className="mb-3"
              controlId="formPythonBruteForce"
            >
              <Form.Label column sm="2">
                Python Brute Force Image:
              </Form.Label>
              <Col sm="10">
                <Form.Control
                  type="file"
            ...
            <Form.Group
              as={Row}
              className="mb-3"
              controlId="formPythonOptimized"
            >
              <Form.Label column sm="2">
                Python Optimized Image:
              </Form.Label>
              <Col sm="10">
                <Form.Control
                  type="file"
            ...
            <Form.Group as={Row} className="mb-3" controlId="formTC1">
              ...
              <Col sm="10">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setComplexities({ ...complexities, tc1: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row} className="mb-3" controlId="formSC1">
              ...
              <Col sm="10">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setComplexities({ ...complexities, sc1: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row} className="mb-3" controlId="formTC2">
              ...
              <Col sm="10">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setComplexities({ ...complexities, tc2: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row} className="mb-3" controlId="formSC2">
              ...
              <Col sm="10">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setComplexities({ ...complexities, sc2: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row} className="mb-3" controlId="formTC3">
              ...
              <Col sm="10">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setComplexities({ ...complexities, tc3: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row} className="mb-3" controlId="formSC3">
              ...
              <Col sm="10">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setComplexities({ ...complexities, sc3: e.target.value })
                  }
                  required
                />
              </Col>
